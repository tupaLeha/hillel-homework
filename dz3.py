...
class GoogleUrl(HttpsUrl):
    def __init__(self, scheme=HttpsUrl().scheme, authority='google.com', path=None, query=None, fragment=None):
        self.scheme = scheme
        self.authority = authority
        self.path = path
        self.query = query
...
class WikiUrl(HttpsUrl):
    def __init__(self, scheme=HttpsUrl().scheme, authority='wikipedia.org', path=None, query=None, fragment=None):
        self.scheme = scheme
        self.authority = authority
        self.path = path
        self.query = query
